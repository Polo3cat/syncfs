...
# synchronisation period. It reproduced the default arm cell for cell, because
# the synchronisation period governs the directory-scan path and is not on the
# upload path at all, and the chapter reports one configuration per system.
