...
macro(
  ...
  if(NOT CMAKE_BUILD_TYPE MATCHES "Debug")
    ...
    message(STATUS "*** clang _FORTIFY_SOURCE=3 enabled")
  endif()
  ...
  if(STACK_PROTECTOR)
    ...
    message(STATUS "*** clang -fstack-protector-strong enabled")
  else()
    message(STATUS "*** clang -fstack-protector-strong NOT enabled (not supported)")
  endif()

  check_cxx_compiler_flag(-fcf-protection CF_PROTECTION)
  if(CF_PROTECTION)
    set(NEW_COMPILE_OPTIONS "${NEW_COMPILE_OPTIONS} -fcf-protection")
    message(STATUS "*** clang -fcf-protection enabled")
  else()
    message(STATUS "*** clang -fcf-protection NOT enabled (not supported)")
  endif()
  ...
  if(CLASH_PROTECTION)
    ...
    message(STATUS "*** clang -fstack-clash-protection enabled")
  else()
    message(STATUS "*** clang -fstack-clash-protection NOT enabled (not supported)")
  endif()
